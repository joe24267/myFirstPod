...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/joe24267/myFirstPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'joe' => 'joe24267@gmail.com' }
  s.source           = { :git => https://github.com/joe24267/myFirstPod.git', :tag => s.version.to_s }
